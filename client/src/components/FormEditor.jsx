    ...
    return (
        <div className="p-4">
            ...
            <input
                ...
                className="border p-2 mb-4 w-full"
            />
            <button onClick={() => addQuestion("Categorize")} className="bg-blue-500 text-white px-4 py-2 mr-2">
                Add Categorize Question
            </button>
            <button onClick={() => addQuestion("Cloze")} className="bg-green-500 text-white px-4 py-2 mr-2">
                Add Cloze Question
            </button>
            <button onClick={() => addQuestion("Comprehension")} className="bg-purple-500 text-white px-4 py-2">
